...
#d=-(d+temp=y_unitvec*eyelevel+sqrt(|(d12*12)²-(xz_unitvector*eyelevel)²|))
    execute store result storage player_motion:math d double -0.0001 run scoreboard players operation $d player_motion.internal.math += $temp player_motion.internal.math