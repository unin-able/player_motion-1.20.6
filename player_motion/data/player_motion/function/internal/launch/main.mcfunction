...
execute \
    ...
    store result storage player_motion:math motion_x float 0.0001 run \
...
execute \
    ...
    store result storage player_motion:math motion_y float 0.0001 run \
...
execute \
    ...
    store result storage player_motion:math motion_z float 0.0001 run \
...
attribute @s minecraft:generic.explosion_knockback_resistance \
    modifier add player_motion:disable_knockback_resistance -100 add_value
...
attribute @s minecraft:generic.explosion_knockback_resistance \
    modifier remove player_motion:disable_knockback_resistance
